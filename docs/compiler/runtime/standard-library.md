...
and Duration contract is documented in [temporal compatibility](../../compatibility/stdlib/temporal.md).
The Html and Http value-module contract, including its Blob bridge and bounded
cookie/JSON surface, is documented in
[HTML and HTTP compatibility](../../compatibility/stdlib/html-and-http.md).
The revision-pinned Option, Result, Retry, and native delay contract is
documented in
[Option, Result, and Retry compatibility](../../compatibility/stdlib/option-result-retry.md).
Root equality and explicit output parity are documented in
[comparison compatibility](../../compatibility/stdlib/comparison.md) and
[CLI presentation compatibility](../../compatibility/cli-presentation.md).

The revision-pinned Stream API and lifecycle contract is documented in
[stream compatibility](../../compatibility/stdlib/streams.md).
